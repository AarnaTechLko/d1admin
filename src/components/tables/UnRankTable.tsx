...
const PlayerTable: React.FC<PlayerTableProps> = ({ data = [],
    ...
    const [isUnrankModalOpen, setUnrankModalOpen] = useState<number | null>(null);
                                                    ...
                                                    {player.rankId && (
                                                        <>
                                                            ...
                                                            <UnrankModal
                                                                ...
                                                                onClose={() => setUnrankModalOpen(null)}
                                                                onUnrankSuccess={() => setUnrankModalOpen(null)}
                                                            />
                                ...
                                <div className="space-y-4">
                                    {suspendPlayer.suspend === 1 ? (
                                                    ...
                                                    onClick={async () => {
                                                        ...
                                                        try {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                text: `${suspendPlayer.firstName} suspended for ${suspendDays} day(s).`,
                                                            });
                                        ...
                                        <>
                                            ...
                                            <p>
                                                Are you sure you want to unsuspend {suspendPlayer.firstName} {suspendPlayer.lastName}?
                                            </p>
                                            <div className="flex justify-end gap-2">
                                                <Button variant="outline" onClick={() => setSuspendOpen(false)}>
                                                    Cancel
                                                ...
                                                <Button
                                                    ...
                                                    onClick={async () => {
                                                        ...
                                                        const confirm = await Swal.fire({
                                                            ...
                                                            text: `Unsuspend ${suspendPlayer.firstName}?`,
                                                        ...
                                                        try {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                text: `${suspendPlayer.firstName} has been unsuspended.`,
                                                            });
