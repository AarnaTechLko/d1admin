...
const ReceivedTickets: React.FC = () => {
  useRoleGuard();
...
const handleModalSubmit = async () => {
  ...
  return (
    <div>
      ...
      <PageBreadcrumb pageTitle="Received Ticket" onStatus={setStatusQuery} onSearch={setSearchQuery} onDays={setDaysQuery} />
  
      <div className="flex justify-between items-center gap-2 p-4 pt-8 dark:border-white/[0.05]">

        <p className="font-bold">Tickets Received</p>
                ...
                receivedTickets.map((ticket) => (
                  <TableRow key={ticket.id}>
                    ...
                    <TableCell className="px-4 py-3 text-gray-500 dark:text-gray-400">
                        ...
                        <p>{ticket.assign_to_username || 'Assign To'}</p>
