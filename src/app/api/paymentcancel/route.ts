...
import { payments, playerEvaluation, coachearnings, users, coaches } from "@/lib/schema";
...
export async function PATCH(req: NextRequest) {
    ...
    const mailmessage = `<p> Our admins have decided to cancel your Evaluation Request to ${coachEmail[0].firstName} and will not be charged. No further action is required on your end.</p>
    ...
    await axios.post(`https://d1notes.com/api/geolocation/coach`, {
            type: "coach",
