  ...
  try {
    ...
    const payments = await db
      .select({
        ...
        booking_id:
          video_payments.booking_id,

        amount:
          video_payments.amount,

        original_amount:
          video_payments.original_amount,

        status:
          video_payments.status,

        currency:
          video_payments.currency,

        payment_info:
          video_payments.payment_info,

        created_at:
          video_payments.created_at,

        description:
          video_payments.description,

        intent_id:
          video_payments.intent_id,

        charge_id:
          video_payments.charge_id,

        is_deleted:
          video_payments.is_deleted,

        company_amount:
          video_payments.company_amount,

        commission_rate:
          video_payments.commission_rate,
      ...
      // Evaluation Join AFTER booking join
      .leftJoin(
        playerEvaluation,
        eq(
          bookings.evaluation_id,
